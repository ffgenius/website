    ...
    <template v-for="(route, idx) in posts" :key="route.path">
      ...
      >
        ...
        >
          <li class="no-underline" flex="~ col md:row gap-2 md:items-center">
            ...
            <div flex="~ gap-2 items-center">
              <span
                ...
                class="i-ri:group-2-line"
                title="In person"
              />
              <span
                v-if="route.recording || route.video"
                align-middle op50 flex-none
                class="i-ri:film-line"
                title="Provided in video"
              />
              <span
                v-if="route.radio"
                align-middle op50 flex-none
                class="i-ri:radio-line"
              ...
              <span v-if="route.place" text-sm op40 ws-nowrap class="md:hidden">· {{ route.place }}</span>
              <span
                v-if="route.lang === 'zh'"
                align-middle flex-none
          ...
          <div v-if="route.place" op50 text-sm hidden mt--2 class="md:block">
            {{ route.place }}
          </div>
        </component>
      </div>
