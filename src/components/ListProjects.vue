...
<template>
  <div class="max-w-300 mx-auto">
    <p text-center mt--6 mb5 op50 text-lg italic>
      Collect useful projects for easy searching.
    </p>
      ...
      >
        ...
        >
          <div v-if="item.icon" class="pt-2 pr-5">
            <Dockerfile v-if="item.icon === 'dockerfile'" class="text-4xl opacity-50" />
            <DigitalOcean v-if="item.icon === 'digital'" class="text-4xl opacity-50" />
